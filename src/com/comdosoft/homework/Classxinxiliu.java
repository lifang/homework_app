...
public class Classxinxiliu extends Activity implements OnHeaderRefreshListener,
					...
					try {
						...
						for (int i = 0; i < jsonArray2.length(); ++i) {
							...
							lookStr_micropost = new Micropost(
									...
									name, content, avatar_url, created_at,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// main_class_classGv = (GridView)
		// findViewById(R.id.main_class_classGv);
		// main_class_classesTv = (TextView)
		// findViewById(R.id.main_class_classesTv);
